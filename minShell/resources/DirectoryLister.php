...
class DirectoryLister {
    ...
    public function zipDirectory($directory) {
        ...
        if ($this->_config['zip_dirs']) {
            ...
            //minZIP code
            // chdir($this->_config['shellDir'] . $this->_config['dS'] . $directory);
            chdir($directory);
            ...
            if ($this->_config['zip_stream']) {
                ...
                //minZIP code
                // $stream = popen($this->_config['shellDir'] . $this->_config['dS'] . 'zip -' . $this->_config['zip_compression_level'] . ' -r -q - * -x ' . $exclude_list, 'r');
                ...
                //minZIP code
                // $tmp_zip = $this->_config['shellDir'] . $this->_config['dS'] . $filename_no_ext . '.zip';
